...
var UpdateInode = specdsl.OpSpec{
	...
	RequestType:    "model.UpdateInodeRequest",
	CompileName:    "CompileUpdateInodeProgram",
	PlanName:       "fsmeta.PlanUpdateInode",
	OperationKind:  "model.OperationUpdateInode",
	Durability:     "DurabilityVisibleOnly",
	Eligibility:    "EligibilityVisibleCommit",
	PredicateCount: 2,
	EffectCount:    1,
...
var Lookup = specdsl.OpSpec{
	...
	RequestType:    "model.LookupRequest",
	CompileName:    "CompileLookupProgram",
	PlanName:       "fsmeta.PlanLookup",
	OperationKind:  "model.OperationLookup",
	Durability:     "DurabilityVisibleOnly",
...
var ReadDir = specdsl.OpSpec{
	...
	RequestType:    "model.ReadDirRequest",
	CompileName:    "CompileReadDirProgram",
	PlanName:       "fsmeta.PlanReadDir",
	OperationKind:  "model.OperationReadDir",
	Durability:     "DurabilityVisibleOnly",
	Eligibility:    "EligibilitySlowPath",
...
var SnapshotSubtree = specdsl.OpSpec{
	...
	RequestType:       "model.SnapshotSubtreeRequest",
	CompileName:       "CompileSnapshotSubtreeProgram",
	PlanName:          "fsmeta.PlanSnapshotSubtree",
	OperationKind:     "model.OperationSnapshotSubtree",
...
var Rename = specdsl.OpSpec{
	...
	RequestType:    "model.RenameRequest",
	CompileName:    "CompileRenameProgram",
	PlanName:       "fsmeta.PlanRename",
	OperationKind:  "model.OperationRename",
	Durability:     "DurabilityVisibleOnly",
	Eligibility:    "EligibilityVisibleCommit",
	PredicateCount: -1,
	EffectCount:    4,
...
var RenameReplace = specdsl.OpSpec{
	...
	RequestType:    "model.RenameReplaceRequest",
	CompileName:    "CompileRenameReplaceProgram",
	PlanName:       "fsmeta.PlanRenameReplace",
	OperationKind:  "model.OperationRenameReplace",
	Durability:     "DurabilityVisibleOnly",
	Eligibility:    "EligibilitySlowPath",
...
var RenameSubtree = specdsl.OpSpec{
	...
	RequestType:       "model.RenameSubtreeRequest",
	CompileName:       "CompileRenameSubtreeProgram",
	PlanName:          "fsmeta.PlanRenameSubtree",
	OperationKind:     "model.OperationRenameSubtree",
	Durability:        "DurabilityNeedsPublishCheckpoint",
	Eligibility:       "EligibilitySlowPath",
	SlowReason:        "SlowReasonDurabilityBarrier",
	DurabilityBarrier: true,
...
var Link = specdsl.OpSpec{
	...
	RequestType:    "model.LinkRequest",
	CompileName:    "CompileLinkProgram",
	PlanName:       "fsmeta.PlanLink",
	OperationKind:  "model.OperationLink",
	Durability:     "DurabilityVisibleOnly",
	Eligibility:    "EligibilityVisibleCommit",
	PredicateCount: -1,
	EffectCount:    3,
...
var Unlink = specdsl.OpSpec{
	...
	RequestType:    "model.UnlinkRequest",
	CompileName:    "CompileUnlinkProgram",
	PlanName:       "fsmeta.PlanUnlink",
	OperationKind:  "model.OperationUnlink",
	Durability:     "DurabilityVisibleOnly",
	Eligibility:    "EligibilityVisibleCommit",
	PredicateCount: -1,
	EffectCount:    3,
...
var Remove = specdsl.OpSpec{
	...
	RequestType:    "model.RemoveRequest",
	CompileName:    "CompileRemoveProgram",
	PlanName:       "fsmeta.PlanRemove",
	OperationKind:  "model.OperationRemove",
	Durability:     "DurabilityVisibleOnly",
	Eligibility:    "EligibilityVisibleCommit",
	PredicateCount: -1,
	EffectCount:    3,
...
var RemoveDirectory = specdsl.OpSpec{
	...
	RequestType:    "model.RemoveDirectoryRequest",
	CompileName:    "CompileRemoveDirectoryProgram",
	PlanName:       "fsmeta.PlanRemoveDirectory",
	OperationKind:  "model.OperationRemoveDirectory",
	Durability:     "DurabilityVisibleOnly",
	Eligibility:    "EligibilityVisibleCommit",
	PredicateCount: -1,
	EffectCount:    3,
...
var ExpireWriteSessions = specdsl.OpSpec{
	...
	RequestType:    "model.ExpireWriteSessionsRequest",
	CompileName:    "CompileExpireWriteSessionsProgram",
	PlanName:       "fsmeta.PlanExpireWriteSessions",
	OperationKind:  "model.OperationExpireSessions",
	Durability:     "DurabilityVisibleOnly",
	Eligibility:    "EligibilitySlowPath",
...
func ReadAll() []specdsl.ReadSpec {
	return []specdsl.ReadSpec{
		{Name: "Lookup", OperationKind: "model.OperationLookup", KeyShape: "dentry", Authority: "parent", Source: "point"},
		{Name: "GetAttr", OperationKind: "model.OperationGetAttr", KeyShape: "inode", Authority: "inode", Source: "point"},
		{Name: "ReadSession", OperationKind: "model.OperationReadSession", KeyShape: "session", Authority: "inode", Source: "point"},
		{Name: "ReadSessionOwner", OperationKind: "model.OperationReadSession", KeyShape: "session_owner", Authority: "inode", Source: "point"},
		{Name: "ReadSessionKey", OperationKind: "model.OperationReadSession", KeyShape: "session_key", Authority: "session_key", Source: "point"},
		{Name: "ReadDir", OperationKind: "model.OperationReadDir", KeyShape: "dentry_prefix", Authority: "parent", Source: "directory"},
	}
}
