...
func emitReadPrograms(readSpecs []specdsl.ReadSpec) ([]byte, error) {
	required := map[string]specdsl.ReadSpec{
		"Lookup":           {OperationKind: "model.OperationLookup", KeyShape: "dentry", Authority: "parent", Source: "point"},
		"GetAttr":          {OperationKind: "model.OperationGetAttr", KeyShape: "inode", Authority: "inode", Source: "point"},
		"ReadSession":      {OperationKind: "model.OperationReadSession", KeyShape: "session", Authority: "inode", Source: "point"},
		"ReadSessionOwner": {OperationKind: "model.OperationReadSession", KeyShape: "session_owner", Authority: "inode", Source: "point"},
		"ReadSessionKey":   {OperationKind: "model.OperationReadSession", KeyShape: "session_key", Authority: "session_key", Source: "point"},
		"ReadDir":          {OperationKind: "model.OperationReadDir", KeyShape: "dentry_prefix", Authority: "parent", Source: "directory"},
	}
	...
	b.WriteString(")\n\n")
	b.WriteString("func CompileLookupReadProgram(req model.LookupRequest, mount model.MountIdentity) (ReadProgram, error) {\n")
	b.WriteString("\tplan, err := layout.PlanLookup(req, mount)\n")
	...
	b.WriteString("}\n\n")
	b.WriteString("func CompileGetAttrReadProgram(mount model.MountIdentity, inode model.InodeID) (ReadProgram, error) {\n")
	b.WriteString("\tkey, err := layout.EncodeInodeKey(mount, inode)\n")
	b.WriteString("\tif err != nil {\n")
	b.WriteString("\t\treturn ReadProgram{}, err\n")
	b.WriteString("\t}\n")
	...
	b.WriteString("}\n\n")
	b.WriteString("func CompileReadDirPlusInodeKeys(mount model.MountIdentity, dentries []model.DentryRecord) ([][]byte, error) {\n")
	b.WriteString("\tkeys := make([][]byte, len(dentries))\n")
	b.WriteString("\tfor i, dentry := range dentries {\n")
	b.WriteString("\t\tkey, err := layout.EncodeInodeKey(mount, dentry.Inode)\n")
	b.WriteString("\t\tif err != nil {\n")
	...
	b.WriteString("}\n\n")
	b.WriteString("func CompileReadSessionProgram(mount model.MountIdentity, inode model.InodeID, session model.SessionID) (ReadProgram, error) {\n")
	b.WriteString("\tkey, err := layout.EncodeSessionKey(mount, inode, session)\n")
	b.WriteString("\tif err != nil {\n")
	b.WriteString("\t\treturn ReadProgram{}, err\n")
	b.WriteString("\t}\n")
	b.WriteString("\tref := keyRef(KeyAccessRead, key)\n")
	...
	b.WriteString("}\n\n")
	b.WriteString("func CompileReadSessionOwnerProgram(mount model.MountIdentity, inode model.InodeID) (ReadProgram, error) {\n")
	b.WriteString("\tkey, err := layout.EncodeInodeSessionKey(mount, inode)\n")
	b.WriteString("\tif err != nil {\n")
	b.WriteString("\t\treturn ReadProgram{}, err\n")
	b.WriteString("\t}\n")
	b.WriteString("\tref := keyRef(KeyAccessRead, key)\n")
	b.WriteString("\treturn ReadProgram{Kind: ReadProgramReadSession, Plan: layout.OperationPlan{Kind: model.OperationReadSession, Mount: mount.MountID, PrimaryKey: cloneBytes(key), ReadKeys: [][]byte{cloneBytes(key)}, ReadPrefixes: emptyKeySet, MutateKeys: emptyKeySet}, Authority: AuthorityPlan{Scope: scopeFor(mount, nil, []model.InodeID{inode}), Required: true, Fence: FenceActiveAuthority}, Footprint: KeyFootprint{Reads: []KeyRef{ref}, ConflictKeys: []KeyRef{ref}, EstimatedBytes: uint64(len(key))}, Key: cloneBytes(key)}, nil\n")
	b.WriteString("}\n\n")
	b.WriteString("func CompileReadSessionKeyProgram(mount model.MountIdentity, key []byte) (ReadProgram, error) {\n")
	b.WriteString("\tparts, ok := layout.InspectKey(key)\n")
	b.WriteString("\tif !ok || parts.Kind != layout.KeyKindSession || parts.MountKeyID != mount.MountKeyID || parts.Inode == 0 {\n")
	b.WriteString("\t\treturn ReadProgram{}, model.ErrInvalidRequest\n")
	b.WriteString("\t}\n")
	b.WriteString("\tref := keyRef(KeyAccessRead, key)\n")
	...
	b.WriteString("}\n\n")
	b.WriteString("func CompileDirectoryReadPlan(req model.ReadDirRequest, mount model.MountIdentity, includeOverlay, overlayOnly bool) (DirectoryReadPlan, error) {\n")
	b.WriteString("\tplan, err := layout.PlanReadDir(req, mount)\n")
	b.WriteString("\tif err != nil {\n")
	b.WriteString("\t\treturn DirectoryReadPlan{}, err\n")
	b.WriteString("\t}\n")
	b.WriteString("\tif len(plan.ReadPrefixes) != 1 {\n")
	b.WriteString("\t\treturn DirectoryReadPlan{}, model.ErrInvalidRequest\n")
	b.WriteString("\t}\n")
...
func emitDispatch(specs []specdsl.OpSpec) ([]byte, error) {
	...
	b.WriteString("package compile\n\n")
	b.WriteString("import \"github.com/feichai0017/NoKV/fsmeta/model\"\n\n")
...
func emitCreate(spec specdsl.OpSpec) ([]byte, error) {
	...
	b.WriteString("\t}\n")
	b.WriteString("\tparentInodeKey, err := layout.EncodeInodeKey(mount, req.Parent)\n")
	b.WriteString("\tif err != nil {\n")
	fmt.Fprintf(&b, "\t\treturn %s{}, err\n", spec.ProgramType)
	b.WriteString("\t}\n")
	b.WriteString("\tdentryKey, err := layout.EncodeDentryKey(mount, req.Parent, req.Name)\n")
	b.WriteString("\tif err != nil {\n")
	fmt.Fprintf(&b, "\t\treturn %s{}, err\n", spec.ProgramType)
	b.WriteString("\t}\n")
	b.WriteString("\tinodeKey, err := layout.EncodeInodeKey(mount, inodeID)\n")
	b.WriteString("\tif err != nil {\n")
	fmt.Fprintf(&b, "\t\treturn %s{}, err\n", spec.ProgramType)
	b.WriteString("\t}\n")
	b.WriteString("\tplanKeys := [][]byte{parentInodeKey, dentryKey, inodeKey}\n")
	b.WriteString("\tplan := layout.OperationPlan{\n")
	b.WriteString("\t\tKind:       model.OperationCreate,\n")
	...
	b.WriteString("\tdentry := model.DentryRecord{Parent: req.Parent, Name: req.Name, Inode: inodeID, Type: inode.Type}\n")
	b.WriteString("\tdentryValue, err := layout.EncodeDentryValue(dentry)\n")
	b.WriteString("\tif err != nil {\n")
	fmt.Fprintf(&b, "\t\treturn %s{}, err\n", spec.ProgramType)
	b.WriteString("\t}\n")
	b.WriteString("\tinodeValue, err := layout.EncodeInodeValue(inode)\n")
	b.WriteString("\tif err != nil {\n")
	fmt.Fprintf(&b, "\t\treturn %s{}, err\n", spec.ProgramType)
	b.WriteString("\t}\n")
	b.WriteString("\tparentBucket := layout.BucketForInodeID(req.Parent)\n")
	b.WriteString("\tinodeBucket := layout.BucketForInodeID(inodeID)\n")
	b.WriteString("\tbuckets := []layout.AffinityBucket{parentBucket}\n")
	b.WriteString("\tif inodeBucket != parentBucket {\n")
	b.WriteString("\t\tif inodeBucket < parentBucket {\n")
	b.WriteString("\t\t\tbuckets = []layout.AffinityBucket{inodeBucket, parentBucket}\n")
	b.WriteString("\t\t} else {\n")
	b.WriteString("\t\t\tbuckets = []layout.AffinityBucket{parentBucket, inodeBucket}\n")
	b.WriteString("\t\t}\n")
	b.WriteString("\t}\n")
	b.WriteString("\tdelta := SemanticDelta{\n")
	b.WriteString("\t\tKind:      plan.Kind,\n")
	b.WriteString("\t\tPlan:      plan,\n")
	b.WriteString("\t\tAuthority: AuthorityScope{Mount: mount.MountID, MountKeyID: mount.MountKeyID, Buckets: buckets, Parents: []model.InodeID{req.Parent}, Inodes: []model.InodeID{inodeID}},\n")
	...
	fmt.Fprintf(&b, "\t\treturn %s{}, model.ErrInvalidRequest\n", spec.ProgramType)
	b.WriteString("\t}\n")
	...
	b.WriteString("\tif delta.Kind != model.OperationCreate || len(delta.ReadPredicates) != 3 || len(delta.WriteEffects) != 3 {\n")
	b.WriteString("\t\treturn CompiledOp{}, model.ErrInvalidRequest\n")
	b.WriteString("\t}\n")
	...
	b.WriteString("\tparentParts, ok := layout.InspectKey(delta.WriteEffects[0].Key)\n")
	b.WriteString("\tif !ok {\n")
	b.WriteString("\t\treturn CompiledOp{}, model.ErrInvalidRequest\n")
	b.WriteString("\t}\n")
	...
	b.WriteString("}\n\n")
	b.WriteString("func compileCreateWatchProjections(delta SemanticDelta, dentryParts layout.KeyParts, inodeParts layout.KeyParts) []WatchProjection {\n")
...
func emitCompileEntry(b *bytes.Buffer, spec specdsl.OpSpec) error {
	...
	if spec.HasOptions {
		fmt.Fprintf(b, "func %s(req %s, mount model.MountIdentity, opts ...Option) (%s, error) {\n", spec.CompileName, spec.RequestType, spec.ProgramType)
		b.WriteString("\toptions := collectOptions(opts...)\n")
	} else {
		fmt.Fprintf(b, "func %s(req %s, mount model.MountIdentity) (%s, error) {\n", spec.CompileName, spec.RequestType, spec.ProgramType)
	}
	...
	if specUsesKeyBinding(spec, "owner") {
		b.WriteString("\townerKey, err := layout.EncodeInodeSessionKey(mount, req.Inode)\n")
		b.WriteString("\tif err != nil {\n")
		fmt.Fprintf(b, "\t\treturn %s{}, err\n", spec.ProgramType)
		b.WriteString("\t}\n")
	}
...
func inodeSliceExpr(exprs []string) string {
	...
	return "[]model.InodeID{" + strings.Join(exprs, ", ") + "}"
}
...
func emitAOTCompiledOpBody(b *bytes.Buffer) {
	...
	b.WriteString("\t\t}\n")
	b.WriteString("\t\tif parts, ok := layout.InspectKey(effect.Key); ok {\n")
	...
	b.WriteString("\t\t\t}\n")
	b.WriteString("\t\t\tparts, ok := layout.InspectKey(effect.Key)\n")
	b.WriteString("\t\t\tif !ok || parts.Kind != layout.KeyKindDentry {\n")
	b.WriteString("\t\t\t\tcontinue\n")
	b.WriteString("\t\t\t}\n")
	...
	b.WriteString("\t\t\tif len(effect.Value) > 0 {\n")
	b.WriteString("\t\t\t\tif dentry, err := layout.DecodeDentryValue(effect.Value); err == nil {\n")
